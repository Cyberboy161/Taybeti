...
object CryptoUtils {
    ...
    /**
     * Pad plaintext to exactly PADDED_SIZE bytes.
     * Layout: [2-byte big-endian original length][original plaintext][random fill]
     */
    ...
    /**
     * Extract original plaintext from padded data.
     * Also accepts legacy (unpadded) ciphertext for backward compatibility.
     */
    private fun unpad(padded: ByteArray): ByteArray {
        ...
        // Legacy: treat as raw unpadded plaintext
        return padded
    }
